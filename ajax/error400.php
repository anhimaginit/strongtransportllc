		...
		<div class="row">
			<div class="col-sm-12">
				<div class="text-center error-box">
					...
					<h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> <u>Bad</u> Request </strong></h2>
					<br />
					<p class="lead">
					</p>
					<p class="font-md">
						<b>Your browser sent a request that this server could not understand.
                     Size of a request header field exceeds server limit.</b>
					</p>
					<br>
