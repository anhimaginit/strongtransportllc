...
function modal_calendar1(){

}
modal_calendar1.NAME         = "modal_inv";
modal_calendar1.VERSION      = "1.2";
modal_calendar1.DESCRIPTION  = "Class modal_calendar1";

modal_calendar1.prototype.constructor = modal_calendar1;
modal_calendar1.prototype = {
    init: function(){
        var current_date1 = new Date("2023-10-02").format('Y-m-d');
        //modal_calendar1.prototype.get_calendar_date1(current_date1,"2",'Admin')
        modal_calendar1.prototype.test()
       // modal_calendar1.prototype.depot_add_update();
    ...
    test:function(){
        ...
        var _link =link._rate_shipping_id;
        $.ajax({
            "async": true,
            "crossDomain": true,
            "url": _link,
    ...
    get_calendar_date1:function(date,contact_id,role){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var remaining = 0
                if(totalRecords%2 >0) remaining=1;

                var totalPages = remaining + (totalRecords -totalRecords%2)/2;
                    ...
                    onPageClick:function (event, page) {
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                if(data=res.list==undefined) return
                                modal_calendar1.prototype.view_task_in_calendar(res.list)
    ...
    view_task_in_calendar:function(data){
              ...
              tr +='<tr class="'+class1+'">' +
                  ...
                  '<td><span class="is_hide">' +
                      ...
                      '<div class="color-ligh-blue">'+item.product_sku.distance+' miles</div>' +
                        ...
                        '<div class="'+close1+'">'+item.status+'</div>' +
                    '</span>' +
        ...
        $('#tbl-task-in_calendar1 tbody').html(tr);
        //bind event
        modal_calendar1.prototype.calendar_event();
    },
    /***********************************/
    calendar_event:function(){
        $('#tbl-task-in_calendar .btn-edit').unbind('click').bind('click',function(){
            ...
            if(is_admin !="Admin"){
                ...
                modal_calendar1.prototype.driver_select2_el("#calendar-modal .driver-id-v",'.driver-id-v','#calendar-modal',function(){
               ...
               // modal_calendar1.prototype.driver_select2_el("#calendar-modal .driver-id-v",'.driver-id-v','#calendar-modal')
            }
        });
        ...
        $('#tbl-task-in_calendar .btn-save').unbind('click').bind('click',function(){
            var $me = $(this)
            modal_calendar1.prototype.cal_update('#calendar-modal',$me)
        })
    ...
    cal_save:function(modal_id,$me){
        ...
        modal_calendar1.prototype.save_calendar(_formData,modal_id,$me)
    },
    /****************************/
    ...
    depot_add_update:function(){
        var _formData = {
            ...
            data_post:{
                ...
                depot_address: "3747 East Ave, Berwyn, IL 60402"
            }
        }
        var _link =link._depot_new_update;
        $.ajax({
            "async": true,
            "crossDomain": true,
            "url": _link,
...
var md_calendar = new modal_calendar1();
$(function(){
    md_calendar.init();
});